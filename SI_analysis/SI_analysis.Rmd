...
Section 1 uses a daily averaged observations (rather than a downsampled data set that is presented in the main text) to demonstrate how different averaging and downsampling schemes can modify the PE calculations.

Section 2 uses different PE hyperparameters (d, tau) to demonstrate consistency among conclusions when the hyperparameters are selected.


```{r generate targets, include=FALSE}
knitr::opts_chunk$set(echo = TRUE)
setwd(here::here())
library(tidyverse)
library(ggridges)
library(ggpubr)
source("01_generate_targets.R")
```
...
## 2. Modification of hyperparameters
